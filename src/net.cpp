...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Chopcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"54.174.247.123", "54.174.247.123"}, // My amazon aws instance,
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"chopcointools.com", "testnet-seed.chopcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Chopcoin is probably already running."), addrBind.ToString().c_str());
        else
